  ...
  return (
    <div style={{
      ...
      <div onClick={e => e.stopPropagation()} style={{
        ...
        <div style={{ fontSize: 24, marginBottom: 12 }}>Note:</div>
        <p style={{ fontSize: 15, color: "#E8D8A0", lineHeight: 1.7, fontFamily: "Georgia, serif", fontStyle: "italic", marginBottom: 20 }}>{msg}</p>
